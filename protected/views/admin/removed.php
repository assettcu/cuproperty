<?php
$system = new System;
$listings = $system->get_all_removed();
...
<div id="administration">
    <ul class="admin-nav">
        ...
        <li id="removed" class="selected"><div class="message-icon"><?php echo StdLib::load_image("close_delete","19px"); ?></div> Listings Removed</li>
    </ul>
    ...
    <div class="admin-panel">
        <table id="issues-table" class="fancy-table" width="100%">
            ...
            <tbody>
                ...
                <?php else: ?>
                    <tr>
                        <td colspan="4" class="empty">There are no removed listings.</td>
                    </tr>
                <?php endif; ?>
            </tbody>
        </table>
